            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="flex items-center justify-between mb-4 pb-3 border-b border-gray-100 dark:border-gray-800">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Pilih barber, layanan, tanggal & jam yang
                            tersedia</p>
                    </div>
                    <span
                ...
                <p
                    class="text-xs text-gray-500 dark:text-gray-400 mb-5 rounded-xl bg-gray-50 dark:bg-gray-800/50 p-3 border border-gray-100 dark:border-gray-800">
                    <i class="fa-solid fa-info-circle text-red-500 mr-1 mt-1"></i> <strong
                        class="text-gray-700 dark:text-red-300">Pastikan datang 15 menit sebelum jadwal booking untuk
                        menghindari
                        dibatalkan</strong>
                </p>
                ...
                <form action="{{ route('pelanggan.booking.store') }}" method="POST">@csrf
                    <div class="space-y-5">
                        ...
                        <button type="submit"
                            class="w-full rounded-xl bg-brand-500 px-5 py-3 text-sm font-bold text-white shadow-theme-xs hover:bg-brand-600 transition">
