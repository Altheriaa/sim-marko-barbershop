...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
    ...
    <div class="lg:col-span-6 space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <h3 class="text-lg font-bold text-gray-800 dark:text-white/90 mb-1">Reservasi Barbershop</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mb-5">
                ...
                Istirahat: <strong class="text-gray-700 dark:text-gray-300">13:00–14:00</strong> &amp; <strong class="text-gray-700 dark:text-gray-300">18:00–19:30</strong>
            </p>
            ...
            <form action="{{ route('pelanggan.booking.store') }}" method="POST">@csrf
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="barber_id" id="barber_id" required class="h-11 w-full rounded-xl border border-gray-300 bg-transparent px-4 py-2.5 text-sm font-medium text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                    ...
                    <div>
                        ...
                        <select name="layanan_id" id="layanan_id" required class="h-11 w-full rounded-xl border border-gray-300 bg-transparent px-4 py-2.5 text-sm font-medium text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" required min="{{ date('Y-m-d') }}"
    ...
    <div class="lg:col-span-6 space-y-4">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between pb-4 border-b border-gray-200 dark:border-gray-800 mb-4">
                <div>
                    <h3 class="text-lg font-bold text-gray-800 dark:text-white">Pilihan Layanan & Paket</h3>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Klik kartu layanan untuk memilihnya langsung</p>
                </div>
                <span class="rounded-lg bg-gray-100 dark:bg-gray-800 px-2.5 py-1 text-xs font-bold text-gray-600 dark:text-gray-300">
                    {{ $layanan->count() }} Paket
                </span>
            </div>
