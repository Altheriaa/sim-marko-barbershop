...
@section('content')
    ...
    <div
        ...
        <span class="text-xs uppercase font-bold tracking-widest text-gray-400 dark:text-gray-500 block mb-2">KALENDER
            KERJA</span>
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <form method="GET" action="{{ route('kasir.jadwal.index') }}" class="flex items-center gap-2">
                ...
                @if(!$tanggal->isToday())
                    <a href="?tanggal={{ date('Y-m-d') }}&barber_id={{ $selectedBarber?->id }}"
                        class="rounded-xl border border-brand-300 bg-brand-50 px-3 py-2 text-xs font-semibold text-brand-700 hover:bg-brand-100 dark:bg-brand-950/40 dark:text-brand-400 transition">Hari
                        Ini</a>
                @endif
            </form>
        </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
                        ...
                        <a href="?barber_id={{ $barber->id }}&tanggal={{ $tanggal->toDateString() }}"
                            ...
                            <div class="flex items-center gap-3">
                                <div class="relative">
                                    ...
                                    @else
                                        <div
                                            class="flex h-11 w-11 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-500">
                                            <i class="fa-solid fa-user text-lg"></i>
                                        </div>
                                    @endif
                                    <span
                                        class="absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-white dark:border-gray-900 bg-green-500"></span>
                                </div>
                                <div>
                                    <h4 class="text-sm font-bold text-gray-800 dark:text-white">{{ $barber->name }}</h4>
                                    <span
                                        class="text-[11px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">Barber</span>
                                </div>
                            </div>
                ...
                <div class="mt-5 pt-3 border-t border-dashed border-gray-200 dark:border-gray-800">
                    <a href="{{ route('kasir.barbers.create') }}"
                        class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-300 py-3 text-xs font-bold uppercase tracking-wider text-gray-600 hover:border-brand-500 hover:text-brand-600 dark:border-gray-700 dark:text-gray-400 dark:hover:border-brand-500 transition">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
                <span class="text-xs font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500 block mb-3">STATUS
                    HARI INI</span>

                <div class="grid grid-cols-2 gap-3">
                    <div
                        class="rounded-xl border border-green-200 bg-green-50/50 p-4 text-center dark:border-green-900/30 dark:bg-green-950/20">
                    ...
                    <div
                        class="rounded-xl border border-amber-200 bg-amber-50/50 p-4 text-center dark:border-amber-900/30 dark:bg-amber-950/20">
        ...
        <div class="lg:col-span-8 space-y-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div
                    class="flex flex-wrap items-center justify-between gap-4 pb-5 border-b border-gray-200 dark:border-gray-800">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300">
                ...
                <div class="mt-5 mb-6 overflow-x-auto py-2 border-b border-gray-100 dark:border-gray-800">
                    <div
                        class="flex items-center justify-between min-w-[500px] text-xs font-semibold text-gray-400 dark:text-gray-500">
                        <span>09:00</span>
                        <span>11:00</span>
                ...
                <div class="space-y-4">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/50">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h5 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Waktu Istirahat Makan
                                        Siang</h5>
                            ...
                            <div>
                                <span
                                    class="inline-flex items-center gap-1.5 rounded-full bg-gray-200/70 px-3 py-1 text-xs font-semibold text-gray-600 dark:bg-gray-800 dark:text-gray-400">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/50">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="h-8 w-px bg-gray-200 dark:bg-gray-800 hidden sm:block"></div>
                                <div>
                                    <h5 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Waktu Istirahat
                                        Maghrib</h5>
                                    <span class="text-xs text-gray-400">Rest break operasional</span>
                                </div>
                            </div>
                    ...
                    @forelse($jadwalList as $item)
                        ...
                        @endphp
                        <div
                            class="rounded-xl border p-4 transition shadow-xs {{ $isTersedia ? 'border-brand-200 bg-brand-50/20 dark:border-brand-900/30 dark:bg-brand-950/10' : 'border-amber-200 bg-amber-50/20 dark:border-amber-900/30 dark:bg-amber-950/10' }}">
                            <div class="flex flex-wrap items-center justify-between gap-3">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs text-gray-500 dark:text-gray-400">
                                            @if($activeBooking)
                                                Pelanggan: <strong
                                                    class="text-gray-700 dark:text-gray-300">{{ $activeBooking->user->name ?? 'Walk-in' }}</strong>
                                                ({{ ucfirst($activeBooking->sumber) }})
                                            @elseif($completedBooking)
                                                Pelanggan: <strong
                                                    class="text-gray-700 dark:text-gray-300">{{ $completedBooking->user->name ?? 'Walk-in' }}</strong>
                                                &bull; <span class="text-emerald-600 font-semibold">Pelayanan Selesai</span>
                                            @else
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @elseif($completedBooking)
                                        <span
                                            class="inline-flex items-center gap-1.5 rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400">
