...
@section('content')
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div
            ...
            <div class="flex items-center justify-between pb-4 border-b border-gray-200 dark:border-gray-800 mb-5">
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">Arahkan kamera ke QR Code pelanggan untuk melakukan
                        check-in</p>
                </div>
                <button onclick="startScanner()"
                    class="rounded-xl border border-gray-300 bg-white px-3 py-1.5 text-xs font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 transition">
            ...
            {{-- Camera Viewport --}}
            <div id="qr-reader"
                class="mx-auto overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-900 min-h-[280px] flex items-center justify-center">
            ...
            <div
                class="mt-4 flex flex-wrap items-center justify-between gap-3 p-3.5 rounded-xl border border-dashed border-gray-300 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-900/50">
                <div class="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                    <i class="fa-solid fa-image text-brand-500 text-sm"></i>
                    <span>Atau scan dari foto / tangkapan layar QR Code:</span>
                </div>
                <label
                    class="cursor-pointer inline-flex items-center gap-1.5 rounded-lg bg-white px-3 py-1.5 text-xs font-bold text-gray-700 border border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 transition">
            ...
            <div
                class="mt-4 rounded-xl bg-amber-50/70 p-3.5 text-xs text-amber-800 dark:bg-amber-950/30 dark:text-amber-300 border border-amber-200 dark:border-amber-900">
                <i class="fa-solid fa-circle-info mr-1.5"></i>
                <strong>Catatan Izin Kamera:</strong> Browser Safari/Chrome memerlukan izin kamera atau akses via
                <code>https://markobarber.shop</code>. Jika webcam tidak terhubung, gunakan opsi <strong>Pilih Foto
                    QR</strong> atau <strong>Input Manual</strong>.
            </div>
        ...
        <div
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">Jika kamera tidak tersedia, masukkan kode booking
                secara manual</p>
