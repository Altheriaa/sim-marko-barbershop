        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 dark:border-gray-800">
                    ...
                    <td class="px-5 py-4 text-sm font-medium text-gray-800 dark:text-white/90">{{ $item->nama_layanan }}</td>
                ...
                @empty
                <tr><td colspan="5" class="px-5 py-8 text-center text-sm text-gray-500 dark:text-gray-400">Belum ada data layanan.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
