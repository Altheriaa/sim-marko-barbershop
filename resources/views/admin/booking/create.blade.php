...
<div class="max-w-2xl">
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-1">Buat Booking Walk-in</h3>
        ...
        <form action="{{ route('admin.booking.store') }}" method="POST">@csrf
            <div class="space-y-5">
                {{-- Pilih Barber --}}
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Barber <span class="text-error-500">*</span></label>
                ...
                {{-- Pilih Layanan --}}
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Layanan <span class="text-error-500">*</span></label>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" required min="{{ date('Y-m-d') }}"
