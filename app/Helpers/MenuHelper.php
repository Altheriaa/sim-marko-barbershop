...
class MenuHelper
{
    ...
    public static function getPelangganMenu()
    {
        return [
            [
                'icon' => 'dashboard',
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'charts' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.25 3.75C3.25 3.33579 3.58579 3 4 3C4.41421 3 4.75 3.33579 4.75 3.75V19.25H20.25C20.6642 19.25 21 19.5858 21 20C21 20.4142 20.6642 20.75 20.25 20.75H4C3.58579 20.75 3.25 20.4142 3.25 20V3.75ZM7.5 14.75C7.08579 14.75 6.75 15.0858 6.75 15.5C6.75 15.9142 7.08579 16.25 7.5 16.25H10.5C10.9142 16.25 11.25 15.9142 11.25 15.5C11.25 15.0858 10.9142 14.75 10.5 14.75H7.5ZM6.75 11.5C6.75 11.0858 7.08579 10.75 7.5 10.75H14.5C14.9142 10.75 15.25 11.0858 15.25 11.5C15.25 11.9142 14.9142 12.25 14.5 12.25H7.5C7.08579 12.25 6.75 11.9142 6.75 11.5ZM7.5 6.75C7.08579 6.75 6.75 7.08579 6.75 7.5C6.75 7.91421 7.08579 8.25 7.5 8.25H18.5C18.9142 8.25 19.25 7.91421 19.25 7.5C19.25 7.08579 18.9142 6.75 18.5 6.75H7.5Z" fill="currentColor"></path></svg>',
